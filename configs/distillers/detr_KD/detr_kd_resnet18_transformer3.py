...
distiller = dict(
    ...
    # init_student = True,
    # student_pretrain = '/mnt/Data2/cjc/Py_Project/year2022/KD_KnowledgeDistillation/mmdetection_Test_FGD_DETR/my_output/small_detr_pre.pth',
    distill_cfg = [
                    ...
                    dict(student_module = 'bbox_head.transformer.encoder.layers.2',
                         teacher_module = 'bbox_head.transformer.encoder.layers.2',
                         output_hook = True,
                         methods=[dict(type='EncoderFeatureLoss',
                    ...
                    dict(student_module = 'bbox_head.transformer.encoder.layers.3',
                         teacher_module = 'bbox_head.transformer.encoder.layers.3',
                         output_hook = True,
                         methods=[dict(type='EncoderFeatureLoss',
                                       name='transformer_encoderlayer3_loss',
                                       student_channels = 256,
                                       teacher_channels = 256,
                                       temp=temp,
                                       )
                    ...
                    dict(student_module = 'bbox_head.transformer.encoder.layers.4',
                         teacher_module = 'bbox_head.transformer.encoder.layers.4',
                         output_hook = True,
                         methods=[dict(type='EncoderFeatureLoss',
                                       name='transformer_encoderlayer4_loss',
                                       student_channels=256,
                                       teacher_channels=256,
                                       temp=temp,
                                       )
                    ...
                    dict(student_module = 'bbox_head.transformer.encoder.layers.5',
                         teacher_module = 'bbox_head.transformer.encoder.layers.5',
                         output_hook = True,
                         methods=[dict(type='EncoderFeatureLoss',
                                       name='transformer_encoderlayer5_loss',
                                       student_channels=256,
                                       teacher_channels=256,
                                       temp=temp,
                                       )
...
student_cfg = 'configs/DETR-Small/detr_resnet18_transformer3.py'
