...
distiller = dict(
    ...
    teacher_pretrained = '/mnt/Data2/cjc/Download/Fire_fox/fcos_r101_caffe_fpn_gn-head_mstrain_640-800_2x_coaco-511424d6.pth',
    init_student = True,
...
student_cfg = 'configs/fcos/fcos_r50_caffe_fpn_gn-head_mstrain_640-800_2x_coco.py'
