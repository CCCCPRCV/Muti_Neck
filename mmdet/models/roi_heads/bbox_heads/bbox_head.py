...
class BBoxHead(BaseModule):
    ...
    def loss(self,
        ...
        # print('mmdet/models/roi_heads/bbox_heads/bbox_head.py----------------------------------------------------')
        # print(type(labels))
        # print(labels[0])
        return losses
    ...
    def get_bboxes(self,
        ...
        if rescale and bboxes.size(0) > 0:
            ...
            bboxes = (bboxes.view(bboxes.size(0), -1, 4) / scale_factor).view(
                bboxes.size()[0], -1)
        ###############################################
        # print('-----------------D:\software_data\Py_project\year2023\KD_distiller\FPN_Twins_KD_fcos_retina_merge1\mmdet\models/roi_heads/bbox_heads/bbox_head.py------------')
        # print(bbox_pred.shape,bboxes.shape)
        # print('-----------------------------')
        #################################################
        if cfg is None:
